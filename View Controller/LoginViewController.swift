...
class LoginViewController: UIViewController, UITextFieldDelegate, CAAnimationDelegate, CALayerDelegate {
    ...
    @IBAction func registerPressed(_ sender: UIButton) {
        ...
        if (UserDefaults.standard.object(forKey: "userName") as? String) != nil {
            ...
            AlertNotification().alert(title: NSL_alertTitle_001, message: NSL_alertMessage_001, sender: self, tag: "userName")
            ...
            AlertNotification().alert(title: NSL_alertTitle_002, message: NSL_alertMessage_002, sender: self, tag: "password")
...
//            AlertNotification().alert(title: NSL_alertTitle_003, message: NSL_alertMessage_003, sender: self, tag: "accountCreated")
    ...
    @IBAction func loginPressed(_ sender: UIButton) {
        ...
        if  (storedUserName == nil) {
            ...
            AlertNotification().alert(title: NSL_alertTitle_004, message: NSL_alertMessage_004, sender: self, tag: "userNameStored")
        }
        //else if userName == storedUserName && userPassword == storedPassword {
            ...
            AlertNotification().alert(title: NSL_alertTitle_005, message: NSL_alertMessage_005, sender: self, tag: "authFailed")
        }
    }
...
//            try? AVAudioSession.sharedInstance().setActive(true)
        ...
        if (storedUserName == nil) {
            ...
            createLogin.isHidden = false
            createInfoLabel.isHidden = false
            print("storedUser name == nil")
        
        } else {
            loginButton.isHidden = false
            createLogin.isHidden = true
