//
//  ShareCustomViewController.swift
//  Poli-Extension
//
...
class ShareCustomViewController: UIViewController {
    ...
    // Properties
    @IBAction func postPressedOn(_ sender: UIButton) {
    ...
    func isContentValid() -> Bool {
        ...
        if selectedGoal == nil || titleTextField.text != nil {
    ...
    func didSelectPost() {
        ...
        // Get web title
        let contentTextString: String = titleTextField.text!
    ...
    override func viewDidLoad() {
        ...
        titleTextField.placeholder = NSLocalizedString("Type something here to activate 'Post' button.", comment: "Placeholder")
...
extension ShareCustomViewController:  UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let taskCell = tableView.cellForRow(at: indexPath) {
            ...
            selectedGoal = fetchedGoals[indexPath.row]
            print(selectedGoal?.goalTitle)
        }
    }
